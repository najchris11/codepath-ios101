...
class ViewController: UIViewController,
  ...
  @IBAction func didDoubleTapKart(_ sender: UITapGestureRecognizer) {
    ...
    // YOUR CODE HERE
      //translate(kart: sender.view, by: view.frame.width)//moves the kart forward by the width of the containing view
    ...
    // YOUR CODE HERE
      ...
      }  //moves the kart forward by the width of the containing view and then back after
  }
  ...
  private func moveKart(using gestureRecognizer: UIPanGestureRecognizer) {
    // YOUR CODE HERE
      let location = gestureRecognizer.location(in: view) //get the location
      let kartView = gestureRecognizer.view // get the reference to the kart
